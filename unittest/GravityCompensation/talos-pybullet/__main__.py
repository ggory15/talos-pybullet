...
from .controller import c_control  # Controller functions
...
robotId, robot, revoluteJointIndices = configure_simulation(dt, enableGUI)
...
for i in range(10000):  # run the simulation during dt * i_max seconds (simulation time)
    ...
    jointTorques = c_control(q, qdot, dt, robot, i * dt)
